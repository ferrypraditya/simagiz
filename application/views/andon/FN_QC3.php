          ...
          <?php }else{ ?>
            <td style="width:35%;border:2px solid #fff;font-size: 200%;">
              <table id="lh2" style="height:100%;width:100%;text-align:center;border-spacing: 0px;border:1px solid #000;<?=$bg_L2;?>">
                  <tr>
                    ...
                    <td style="width:45%;border-right:1px solid #000;height: 30%;font-size: 120%;">RR2 LH</td>
            ...
            <td style="width:35%;border:2px solid #fff;font-size: 200%;">
                ...
                <tr>
                  ...
                  <td style="width:45%;border-right:1px solid #000;height: 30%;font-size: 120%;">RR RH</td>
          ...
          <tr>
            <td style="width:35%;border:2px solid #fff;font-size: 200%;">
              <table id="lh" style="height:100%;width:100%;text-align:center;border-spacing: 0px;border:1px solid #000;<?=$bg_L;?>">
                  <tr>
                    ...
                    <td style="width:45%;border-right:1px solid #000;height: 30%;font-size: 120%;">FR LH</td>
            ...
            <td style="width:35%;border:2px solid #fff;font-size: 200%;">
                ...
                <tr>
                  ...
                  <td style="width:45%;border-right:1px solid #000;height: 30%;font-size: 120%;">FR RH</td>
