                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                ...
                                                Best regards,<br><br>Admin<br>PT. Yoska Prima Inti, Ordering
                                                Material<br>
                                                <a href="https://www.yoska.co.id"
                                                    style="color:#2F67F6">www.yoska.co.id</a>
                                            </div>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                ...
                                                                PT. YOSKA PRIMA INTI, Jl. Gajah Tunggal Ds. Pasir Jaya
                                                                Jatiuwung. Tangerang - Banten, ID
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                IAT: <?= gmdate('Y-m-d H:i:s', time() + 60 * 60 * 7) ?>
                                                            </div>
